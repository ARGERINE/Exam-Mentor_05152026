              ...
              <CardContent className="p-8 space-y-8">
                ...
                <SettingRow label="Default Sectional Subject" description="Pre-select this subject when opening a sectional test.">
                  <Select value={defaultSubject} onValueChange={setDefaultSubject}>
                    <SelectTrigger className="w-[180px] rounded-xl bg-slate-50 border-none font-bold text-xs focus:ring-0">
                      <SelectValue />
                    </SelectTrigger>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isActive ? "bg-primary text-white shadow-lg shadow-primary/20" : "bg-slate-50 text-slate-400 hover:bg-slate-100"
                          )}
                        >
                          {day}
                        </button>
