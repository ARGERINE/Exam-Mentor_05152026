...
export default function Mock1ConfirmationPage() {
  const router = useRouter()

  const handleBegin = () => {
    router.push('/exams/attempt?mock=1')
  }
          ...
          <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden bg-white">
            <CardHeader className="p-8 pb-6 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <CardDescription className="text-sm font-medium text-slate-500">
                  Full-length NEET simulation: Standard Level
                </CardDescription>
              </div>
            </CardHeader>
            ...
            <CardContent className="p-8 pt-0 space-y-8">
              ...
              <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10">
                <p className="text-[11px] font-medium text-slate-600 leading-relaxed text-center">
                  This is a full-length NEET simulation at Standard Level. Your result will update your rank band and performance analytics.
                </p>
              </div>
