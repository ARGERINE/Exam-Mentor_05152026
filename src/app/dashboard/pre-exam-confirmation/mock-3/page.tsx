...
export default function Mock3ConfirmationPage() {
  const router = useRouter()

  const handleBegin = () => {
    router.push('/exams/attempt?mock=3')
  }
            ...
            <CardHeader className="p-8 pb-6 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <CardDescription className="text-sm font-medium text-slate-500">
                  Full-length CUET simulation: Advanced Level
                </CardDescription>
              </div>
            </CardHeader>
            ...
            <CardContent className="p-8 pt-0 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <CompositionItem label="Domain 1" count="50 Qs" color="#1a56db" width="25%" />
                  <CompositionItem label="Domain 2" count="50 Qs" color="#0f6e56" width="25%" />
                  <CompositionItem label="General" count="100 Qs" color="#854f0b" width="50%" />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <MarkingChip label="Correct +5" color="bg-emerald-50 text-emerald-600" />
              ...
              <div className="p-4 bg-rose-50 rounded-2xl border border-rose-100">
                <p className="text-[11px] font-medium text-rose-800 leading-relaxed text-center">
                  This is a full-length CUET simulation at Advanced Level. Your result will update your rank band and performance analytics.
                </p>
              </div>
